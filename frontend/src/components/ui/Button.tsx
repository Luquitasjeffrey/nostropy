...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'default', ...props }, ref) => {
    ...
    const variants = {
      primary:
        'bg-primary text-[#0f212e] hover:bg-primaryHover shadow-[0_4px_0_0_#00c700] hover:shadow-[0_2px_0_0_#00c700] hover:translate-y-[2px]',
      success:
        'bg-green-500 text-white hover:bg-green-400 shadow-[0_4px_0_0_#16a34a] hover:shadow-[0_2px_0_0_#16a34a] hover:translate-y-[2px]',
      secondary: 'bg-panel text-white hover:bg-gray-700',
      danger:
        'bg-danger text-white hover:bg-red-400 shadow-[0_4px_0_0_#dc2626] hover:shadow-[0_2px_0_0_#dc2626] hover:translate-y-[2px]',
